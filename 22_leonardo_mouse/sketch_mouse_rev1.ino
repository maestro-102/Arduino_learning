...
void loop(){
  int xVal = readJoystickX(X_AXIS);         // Получить отклонение джойстика по оси Х
  int yVal = readJoystickY(Y_AXIS);         // Получить отклонение по оси Y
